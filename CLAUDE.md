...
```
[PRIMARY_PHONE]    — телефон (подставить во все шаблоны)
...
Если встречаешь эти плейсхолдеры в коде — оставляй как есть и добавляй TODO-комментарий. Не выдумывай значения.
...
| 11 | /distancionnaya-pokupka/ | — | ⏳ | По PAGE_DISTANCIONNAYA.md |
| 12 | /etapy-pokupki/ | — | ⏳ | По PAGE_ETAPY.md |
| 13 | /contacts/ | — | ⏳ | По PAGE_CONTACTS.md |
| 14 | RequestModal + CookieBanner | — | ⏳ | React islands: client:load |
| 15 | Реальные данные Михаила | — | ⏳ | Заменить все [PLACEHOLDER] |
| 16 | Продакшн деплой | — | ⏳ | vercel --prod после финального QA |

**Текущий фокус:** Этап 11 — сборка /distancionnaya-pokupka/ по PAGE_DISTANCIONNAYA_POKUPKA.md.
