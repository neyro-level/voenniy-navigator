...
export const GEO_SERVICES = [
  {
    ...
    description:
      'Первый шаг сервиса: разбираем цель покупки, ограничения по программе, бюджет и следующий реалистичный шаг без случайного выбора объекта.',
  },
  {
    name: 'Подбор новостройки',
    description:
      'Подбираем новостройки и квартиры под цель покупки: для жизни, переезда позже, вложения или дистанционного варианта.',
  },
  {
    name: 'Порядок покупки',
    description:
...
export const GEO_PROCESS = [
  ...
  { step: 'Отсев', description: 'Отбрасываем варианты и объекты, которые не подходят под вашу ситуацию.' },
  { step: 'Подбор', description: 'Показываем квартиры и новостройки, которые реально стоит рассматривать в первую очередь.' },
  { step: 'Следующий шаг', description: 'Фиксируем следующий шаг: расчёт, подбор, документы, дистанционный формат или выход на сделку.' }
] as const;
...
export const GEO_FAQ = [
  ...
  },
  {
    ...
    a: 'Базовые направления сервиса — Краснодар, Крым и дистанционный формат, когда часть этапов можно пройти без постоянного личного присутствия в регионе сделки.',
  },
  {
