...
export const GEO_SERVICES = [
  {
    ...
    description:
      '30-минутная консультация онлайн или в офисе. Уточняю задачу, бюджет, ограничения и подсказываю первый реалистичный шаг.',
  },
  {
    name: 'Подборка ЖК',
    description:
      'Персональная подборка 12 проверенных новостроек с видеоразбором каждого объекта. Подбираю под цель: для жизни, инвестиции, дистанционная покупка.',
  },
  {
    name: 'Маршрут покупки',
    description:
      'Пошаговое сопровождение: от подачи заявки на военную ипотеку до сделки и регистрации права собственности.',
  },
  {
    name: 'Сопровождение сделки',
    description:
      'Проверка документов застройщика, юридическая чистота, помощь на всех этапах.',
  },
  {
    name: 'Дистанционная покупка',
    description:
      'Полное сопровождение без личного присутствия в Краснодаре. Подходит для тех, кто служит в другом регионе.',
  },
] as const;
