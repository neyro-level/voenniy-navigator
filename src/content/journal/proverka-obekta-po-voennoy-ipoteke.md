...
Полный перечень документов для сделки, не только объектных, собран в материале [документы для военной ипотеки](/journal/dokumenty-dlya-voennoy-ipoteke/). Там же логика: что готовит покупатель, что застройщик, что банк.
